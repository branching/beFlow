$(function(){
  ...
  beflow.Graph = Backbone.Model.extend({
    ...
    initialize: function () {
      ...
      $('body').append(this.attributes.layout);
    ...
    connectEdges: function () {
      ...
      beflow.trigger("initialBang");

      var channel = localStorage.getItem("beflow_channel");
      if (channel){
        var value = localStorage.getItem("beflow_value");
        _.defer(function(){
          beflow.trigger(channel, value);
          localStorage.removeItem("beflow_channel");
          localStorage.removeItem("beflow_value")
        })
      }
    }
