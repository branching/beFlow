$(function(){
  ...
  beflow.EdgeView = Backbone.View.extend({
    tagName: "div",
    className: "edge",
    ...
    initialize: function () {
      if (this.model) {
        ...
        // Preview edge
        this.graphSVGElement = beflow.shownGraph.view.edgesSvg;
      }
    ...
    redraw: function () {
      ...
      if (this.model) {
        ...
        beflow.shownGraph.view.resizeEdgeSVG();
      }
    },
    remove: function () {
    ...
    color: function () {
      ...
      if (this.model) {
        // Connected
        this._color = beflow.getWireColor();
        return this._color;
      } else {
        // Preview
        return beflow.wireColors[beflow.wireColorIndex];
      }
    },
    setColor: function(c) {
      this._color = c;
